...
void Codigo::validar(string codigo) {
  ...
  aux << codigo[0];
	...
	condicao_erro = condicao_erro || first_number > 9;
	
	aux << codigo[3];
	aux >> second_number;

	condicao_erro = condicao_erro || second_number > 9;
	
	aux << codigo[4];
	aux >> third_number;

	condicao_erro = condicao_erro || third_number > 9;
	
	aux << codigo[5];
	aux >> fourth_number;

	condicao_erro = condicao_erro || fourth_number > 9;
