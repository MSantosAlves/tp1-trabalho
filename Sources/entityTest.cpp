...
void TU_Sessao::testSuccess()
{
	...
	if (sessao->getIdentificador().getCodigo() != identificador->getCodigo())
		state = FAILURE;
...
void TU_Sala::setUp()
{
  sala = new Sala;
	identificador = new Codigo;
	identificador->setCodigo(COD_SALA);
...
void TU_Sala::testSuccess()
{
	...
	if (sala->getIdentificador().getCodigo() != identificador->getCodigo())
		state = FAILURE;
...
void TU_Peca::setUp()
{
  peca = new Peca;
	identificador = new Codigo;
	identificador->setCodigo(COD_PECA);
...
void TU_Peca::testSuccess()
{
	...
	if (peca->getIdentificador().getCodigo() != identificador->getCodigo())
		state = FAILURE;
